...
| 5 | [05-guardrail.md](05-guardrail.md) | 관측 · 가드레일 — 3지점 검사 · 가리기 · 기록 · 승인 | ⑥ | 커넥니 |
...
| 표·열 · 커넥터 ID · **커넥터 요청·응답 키** · 민감 필드 ID(`F-n`) | ⑤ 지식/도구 | ⑤ 3-1 · 3-2 · 3-3 |
| 비용 금액·상한 · 기록 항목 · **마스킹 거는 곳**(가리는 방법은 ⑤ 소유) · 차단 규칙 · 입력측 불신 표시 · 호출 상한 · 연속 실패 차단 | ⑥ 관측/가드레일 | ⑥ 3-1 ~ 3-2 |
