...
| 값 | 주인 | 개발이 읽을 자리 |
|----|------|----------------|
| **상태 필드 이름** · **단계 간 전달 집합(`K-n`)의 키 이름** | ③ 워크플로우 | ③ 「State 구조」 · 「단계 간 전달 집합」 |
| 단계ID · 타임아웃 · 재시도 · 반복 상한(`max_iter`) · 모델 호출 횟수 | ③ 워크플로우 | ③ 「단계별 설계」 |
...
| 배포 단위 · 포트 · 비밀값 주입 경로 · 저장소 배치 · **기술 스택 7행** | ⑦ 배포 | ⑦ 3-1 ~ 3-4 · 2-3 |
